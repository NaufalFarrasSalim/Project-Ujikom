<?php
// mock data untuk produk (agar mirip dengan database)
$produk = [
    [
...
<head>
    ...
    <style>
        ...
        /* Hero Section (Seperti Foto Besar) */
        .hero {
            background-image: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url('https://images.unsplash.com/photo-1509440159596-0249088772ff?w=1600&q=80');
...
<body>
    ...
    <header>
        <nav>
            <a href="#" class="logo">HOLLAND BAKERY 🍞</a>
            <div class="menu">
                <a href="#">Beranda</a>
                <a href="#menu">Menu</a>
    ...
    <!-- Menu Produk (Menggunakan PHP untuk looping data) -->
        ...
        <div class="grid-produk">
            ...
            <?php foreach($produk as $item): ?>
                <div class="card">
                    ...
                    <img src="<?php echo $item['gambar']; ?>" alt="<?php echo $item['nama']; ?>" class="card-img">
                    <div class="card-body">
                        ...
                        <a href="#" style="color:var(--primary); text-decoration:none; font-weight:bold;">Tambah ke Keranjang &rarr;</a>
                    </div>
                </div>
            <?php endforeach; ?>
            <!-- Akhir Loop PHP -->
